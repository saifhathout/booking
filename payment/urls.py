...
urlpatterns = [
    ...
    path('verify/<int:payment_id>/', views.verify_payment, name='verify_payment'),  # ✅ هذا الرابط
    path('manual-review/<int:payment_id>/', views.manual_review, name='manual_review'),
]